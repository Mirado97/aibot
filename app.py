...
def _make_page() -> str:
    ...
    html = (
        ...
        "</div>"
        "<div class='lbl'>Цена ETH 4h — 90 дней</div><div id='c1'></div>"
        "<div class='lbl'>MACD 4h</div><div id='c2'></div>"
        "<div class='lbl'>Equity</div><div id='c3'></div>"
        "<div class='wrap'>"
        ...
        "<script>"
        "const W=document.body.clientWidth-4,OPT={"
        "layout:{background:{color:'#0e1117'},textColor:'#9ca3af'},"
        "grid:{vertLines:{color:'#1f2937'},horzLines:{color:'#1f2937'}},"
        "timeScale:{timeVisible:true,secondsVisible:false},crosshair:{mode:1},width:W};"
        ...
        "window.addEventListener('resize',()=>{const w=document.body.clientWidth-4;"
